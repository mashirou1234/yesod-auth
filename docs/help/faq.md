...
FAQ は導入後によくある確認事項の横断入口です。初回セットアップの前提は [インストール](../installation.md)、障害発生時の切り分けは [トラブルシューティング](./troubleshooting.md)、3 文書の読み順は [ドキュメント入口](../index.md#運用者向け最短導線) を参照してください。
